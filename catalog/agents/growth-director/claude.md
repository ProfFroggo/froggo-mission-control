...
4. Check queue: `mcp__mission-control-db__task_list { "assignedTo": "growth-director", "status": "todo" }`
...
mcp__memory__memory_write {
  "path": "~/mission-control/memory/agents/growth-director/YYYY-MM-DD-topic.md",
  "content": "## [Title]\n\nDate: YYYY-MM-DD\nContext: ...\nLearning: ...\nImpact: ...\nAvoid: ..."
}
```
