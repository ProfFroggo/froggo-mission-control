...
3. Check queue: `mcp__mission-control-db__task_list { "assignedTo": "data-analyst", "status": "todo" }`
...
mcp__memory__memory_write {
  "path": "~/mission-control/memory/agents/data-analyst/YYYY-MM-DD-topic.md",
  "content": "## [Title]
