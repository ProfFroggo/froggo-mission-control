  ...
  return (
    ...
    <ErrorBoundary panelName="Application Root">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none" style={{ zIndex: -1 }}>
        <svg width="100%" height="100%" viewBox="0 0 2560 1920" preserveAspectRatio="xMidYMid slice" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ opacity: 0.12 }}>
          ...
          <defs>
            ...
            <radialGradient id="bg-grad-0" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(-804.109 -2036.8) rotate(64.9401) scale(6436.87 6304.81)">
              <stop stopColor="var(--color-background)"/><stop offset="0.0833333" stopColor="var(--mission-control-accent)"/><stop offset="0.364583" stopColor="var(--mission-control-accent)"/><stop offset="0.658041" stopColor="var(--color-background)"/><stop offset="0.798521" stopColor="var(--mission-control-accent)"/><stop offset="0.942708" stopColor="var(--color-background)"/><stop offset="1" stopColor="var(--color-background)"/>
            </radialGradient>
            <radialGradient id="bg-grad-1" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(201.6 -1080.02) rotate(64.9401) scale(6436.87 6304.81)">
              <stop stopColor="var(--color-background)"/><stop offset="0.0833333" stopColor="var(--mission-control-accent)"/><stop offset="0.333803" stopColor="var(--mission-control-accent)"/><stop offset="0.658041" stopColor="var(--color-background)"/><stop offset="0.798521" stopColor="var(--mission-control-accent)"/><stop offset="0.942708" stopColor="var(--color-background)"/><stop offset="1" stopColor="var(--color-background)"/>
            </radialGradient>
            <radialGradient id="bg-grad-2" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(912.834 -811.021) rotate(64.9401) scale(6436.87 6304.81)">
              <stop stopColor="var(--color-background)"/><stop offset="0.140625" stopColor="var(--mission-control-accent)"/><stop offset="0.333803" stopColor="var(--mission-control-accent)"/><stop offset="0.658041" stopColor="var(--color-background)"/><stop offset="0.798521" stopColor="var(--mission-control-accent)"/><stop offset="0.942708" stopColor="var(--color-background)"/><stop offset="1" stopColor="var(--color-background)"/>
            </radialGradient>
      ...
      {/* Permanent dark overlay — always covers gradient so it's never raw */}
      <div className="fixed inset-0 bg-mission-control-bg pointer-events-none" style={{ zIndex: -1, opacity: 0.88 }} />
      ...
      <Flex height="100vh">
        ...
        <main
          id="main-content"
          tabIndex={-1}
          className="flex-1 h-full overflow-hidden relative z-0"
          role="main"
