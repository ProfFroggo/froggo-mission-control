...
export const AGENTS: Record<string, AgentConfig> = {
  coder: {
    ...
    systemPromptPath: '/Users/worker/clawd-coder/AGENTS.md',
  ...
  researcher: {
    ...
    systemPromptPath: '/Users/worker/clawd-researcher/AGENTS.md',
  ...
  writer: {
    ...
    systemPromptPath: '/Users/worker/clawd-writer/AGENTS.md',
  ...
  chief: {
    ...
    systemPromptPath: '/Users/worker/clawd-chief/AGENTS.md',
  ...
  clara: {
    ...
    name: 'Clara',
    emoji: '👁️',
    description: 'Independent Reviewer & Quality Auditor',
    workspace: '/Users/worker/clawd-clara',
    workspaceFiles: workspaceFiles('/Users/worker/clawd-clara'),
    systemPromptPath: '/Users/worker/clawd-clara/AGENTS.md',
    capabilities: ['review', 'quality', 'audit'],
    model: 'anthropic/claude-sonnet-4',
  },
  hr: {
    id: 'hr',
    name: 'HR',
    emoji: '🎓',
    description: 'Agent Management & Training Specialist',
    workspace: '/Users/worker/clawd-hr',
    workspaceFiles: workspaceFiles('/Users/worker/clawd-hr'),
    systemPromptPath: '/Users/worker/clawd-hr/AGENTS.md',
    capabilities: ['training', 'agent-creation', 'skill-analysis'],
    model: 'anthropic/claude-sonnet-4',
  },
  'growth-director': {
    id: 'growth-director',
    ...
    emoji: '📈',
    description: 'Head of Growth / Product Marketing',
    workspace: '/Users/worker/clawd-growth-director',
    workspaceFiles: workspaceFiles('/Users/worker/clawd-growth-director'),
    systemPromptPath: '/Users/worker/clawd-growth-director/AGENTS.md',
    capabilities: ['strategy', 'growth', 'marketing', 'gtm'],
    model: 'anthropic/claude-sonnet-4',
  },
  'social-manager': {
    id: 'social-manager',
    name: 'Social Manager',
    emoji: '📱',
    description: 'Content scheduling, posting & social media',
    workspace: '/Users/worker/clawd-social-manager',
    workspaceFiles: workspaceFiles('/Users/worker/clawd-social-manager'),
    systemPromptPath: '/Users/worker/clawd-social-manager/AGENTS.md',
  ...
  voice: {
    ...
    name: 'Voice',
    emoji: '🎙️',
    description: 'Voice & Audio Agent',
    workspace: '/Users/worker/clawd-voice',
    workspaceFiles: workspaceFiles('/Users/worker/clawd-voice'),
    systemPromptPath: '/Users/worker/clawd-voice/AGENTS.md',
