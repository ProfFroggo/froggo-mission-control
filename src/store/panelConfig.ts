...
const DEFAULT_PANELS: PanelConfig[] = [
  ...
  { id: 'automations',   label: 'Automations',       visible: true,  order: 12 },
  { id: 'modules',       label: 'Modules',           visible: true,  order: 13 },
  { id: 'settings',      label: 'Settings',          visible: true,  order: 14 },
  { id: 'toolbar',       label: 'Floating Toolbar',  visible: true,  order: 15 },
  { id: 'notifications', label: 'Notifications',     visible: false, order: 16 },
];
