...
const DEFAULT_PANELS: PanelConfig[] = [
  ...
  { id: 'modules',       label: 'Modules',           visible: true,  order: 11 },
  { id: 'settings',      label: 'Settings',          visible: true,  order: 12 },
  { id: 'toolbar',       label: 'Floating Toolbar',  visible: true,  order: 13 },
  { id: 'notifications', label: 'Notifications',     visible: false, order: 14 },
];
