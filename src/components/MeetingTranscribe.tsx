  ...
  if (initError) {
    return (
      <div className="flex flex-col items-center justify-center h-full bg-gray-900 text-white p-8">
        <FileText className="w-16 h-16 mb-4 text-red-400 opacity-50" />
        <p className="text-red-400 text-sm mb-2">Failed to initialize</p>
                            ...
                            <div className="flex space-x-2">
                              ...
                              {meeting.status === 'ended' && (
                                <button
                                  ...
                                  className="flex-1 py-1 bg-red-600/20 hover:bg-red-600/30 text-red-400 rounded text-xs font-medium transition-colors flex items-center justify-center space-x-1"
                                >
