        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-4 mb-4 text-sm">
            ...
            <div className="relative" ref={sortMenuRef}>
              ...
              {showSortMenu && (
                <div className="absolute right-0 top-full mt-1 z-20 bg-mission-control-surface border border-mission-control-border rounded-xl shadow-xl w-40 py-1 overflow-hidden">
          ...
          {/* Compare bar */}
          {compareIds.length > 0 && (
            <div className="flex items-center gap-3 mb-4 px-3 py-2.5 bg-info-subtle border border-info-border rounded-xl text-sm">
                        ...
                        {agent.avatar ? (
                          <img
                            ...
                            onError={(e) => {
                              ...
                              if (el.parentElement) el.parentElement.textContent = agent.emoji || '';
                            }}
                          />
                        ) : (
                          <Bot size={22} className="text-mission-control-text-dim" />
                        )}
                      </div>
                      <div className="flex-1 min-w-0">
