...
function OverviewTab({
  ...
  return (
    <div className="flex-1 overflow-y-auto p-5 space-y-5">
      {/* Goal + Ring */}
      <div className="flex items-start gap-5 p-4 bg-mission-control-surface border border-mission-control-border rounded-xl">
        <div className="flex flex-col items-center gap-1">
          ...
          <span className="text-xs text-mission-control-text-dim">{doneTasks}/{totalTasks}</span>
        </div>
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-mission-control-text-primary leading-relaxed">
          ...
          <div className="grid grid-cols-2 gap-2">
            {members.map(m => (
              <div key={m.agentId} className="flex items-center gap-2.5 p-2.5 bg-mission-control-surface border border-mission-control-border rounded-lg">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-xs font-medium text-mission-control-text-primary truncate">
            ...
            {activity.map(a => (
              <div key={a.id} className="flex items-start gap-2.5 px-3 py-2.5 bg-mission-control-surface border border-mission-control-border rounded-lg">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-mission-control-text-primary line-clamp-2">{a.message}</p>
                </div>
      ...
      {adding && (
        <div className="mb-3 p-3 bg-mission-control-surface border border-mission-control-border rounded-lg space-y-2">
          <input
            ...
            autoFocus
            className="w-full text-xs px-2 py-1.5 bg-mission-control-bg border border-mission-control-border rounded text-mission-control-text-primary placeholder-mission-control-text-dim focus:outline-none focus:border-mission-control-accent/50"
          />
          <input
            type="date"
            value={newDue}
            onChange={e => setNewDue(e.target.value)}
            className="w-full text-xs px-2 py-1.5 bg-mission-control-bg border border-mission-control-border rounded text-mission-control-text-primary focus:outline-none focus:border-mission-control-accent/50"
          />
          ...
          {milestones.map((ms, i) => {
            ...
            return (
              <div key={ms.id} className="relative flex items-start gap-2.5 py-2">
                ...
                <div className="flex-1 min-w-0">
                  <p className={`text-xs leading-snug ${ms.completed ? 'line-through text-mission-control-text-dim' : 'text-mission-control-text-primary'}`}>
                    {ms.title}
                  </p>
                  {ms.dueDate && (
    ...
    <div className="space-y-1.5">
      ...
      {loading ? (
        ...
        <textarea
          ...
          className="w-full text-xs px-3 py-2.5 bg-mission-control-surface border border-mission-control-border rounded-lg text-mission-control-text-primary placeholder-mission-control-text-dim focus:outline-none focus:border-mission-control-accent/50 resize-y font-mono leading-relaxed"
        />
      )}
    </div>
  );
