    ...
    return (
      <div className="bg-mission-control-surface border border-mission-control-border rounded-2xl p-6 animate-pulse">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {[...Array(4)].map((_, i) => (
            <div key={i} className="h-20 bg-mission-control-border rounded-xl" />
          ))}
        </div>
      </div>
    );
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-1.5">
            {summary.highlights.map((h, i) => (
              <div
                key={i}
                className="flex items-start gap-2 text-sm p-3 bg-mission-control-bg rounded-xl"
              >
...
function ScheduleToast({ visible, onHide }: { visible: boolean; onHide: () => void }) {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-2 px-4 py-3 bg-mission-control-surface border border-mission-control-border rounded-xl shadow-lg text-sm">
            ...
            <div className="bg-mission-control-surface border border-mission-control-border rounded-2xl p-6">
              ...
              <div className="space-y-3">
                {weeklyReport.insights.map((insight, idx) => (
                  <div key={idx} className="p-4 bg-mission-control-bg rounded-xl text-sm">
                    {insight}
                  </div>
                ))}
              </div>
            ...
            <div className="bg-mission-control-surface border border-mission-control-border rounded-2xl p-6">
              ...
              <div className="space-y-3">
                {monthlyReport.agentPerformance.map((agent) => (
                  <div key={agent.agentId} className="p-4 bg-mission-control-bg rounded-xl">
            ...
            <div className="bg-mission-control-surface border border-mission-control-border rounded-2xl p-6">
              ...
              <div className="space-y-3">
                {monthlyReport.projectBreakdown.map((project) => (
                  <div key={project.project} className="p-4 bg-mission-control-bg rounded-xl">
                    <div className="flex items-center justify-between mb-3">
