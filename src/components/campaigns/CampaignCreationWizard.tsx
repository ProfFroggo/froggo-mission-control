    ...
    switch (blockStep) {
          ...
          <div className="flex gap-3">
            <div className="flex-1">
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-mission-control-surface border border-mission-control-border rounded-lg text-mission-control-text focus:outline-none focus:border-mission-control-accent/50 text-sm"
              />
            </div>
            <div className="flex-1">
      ...
      case 'brief': return step === 'brief' ? (
        <div className="mt-3 space-y-3">
          <textarea
            ...
            rows={4}
            className="w-full px-3 py-2.5 bg-mission-control-surface border border-mission-control-border rounded-lg text-mission-control-text placeholder-mission-control-text-dim focus:outline-none focus:border-mission-control-accent/50 resize-none text-sm"
          />
      ...
      case 'review': return step === 'review' ? (
        <div className="mt-3 space-y-4">
          {/* Summary card */}
          <div className="bg-mission-control-bg border border-mission-control-border rounded-xl p-4 space-y-3 text-sm">
          ...
          <div className="flex-shrink-0 border-t border-mission-control-border px-4 py-3">
            <div className="flex items-center gap-2">
              <input
                ...
                autoFocus
                className="flex-1 px-3 py-2 bg-mission-control-surface border border-mission-control-border rounded-lg text-mission-control-text placeholder-mission-control-text-dim focus:outline-none focus:border-mission-control-accent/50 text-sm"
              />
              <button
