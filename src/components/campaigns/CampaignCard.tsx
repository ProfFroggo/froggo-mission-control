...
export const STATUS_CONFIG: Record<string, { label: string; cls: string; dot?: boolean }> = {
  ...
  archived:  { label: 'Archived',  cls: 'text-gray-400/50 bg-gray-400/5 border-gray-400/10' },
};
      ...
      <div className="flex items-start justify-between gap-3 mb-3">
        <div className="flex items-start gap-2.5 min-w-0">
          ...
          <div className="min-w-0">
            <h3 className="font-semibold text-mission-control-text-primary truncate group-hover:text-mission-control-accent transition-colors text-sm">
              {campaign.name}
            </h3>
            {campaign.description && (
              <p className="text-xs text-mission-control-text-dim truncate mt-0.5">{campaign.description}</p>
