...
export default function ModuleDependencyGraph({ modules }: ModuleDependencyGraphProps) {
  ...
  if (nodes.length === 0) {
    return (
      <div className="flex items-center justify-center h-40 text-sm text-mission-control-text-dim border border-mission-control-border rounded-xl">
  ...
  return (
    <div
      className="rounded-xl border border-mission-control-border overflow-hidden"
