...
export default function ResponsiveTable<T extends Record<string, any>>({
      ...
      <div className={`space-y-3 ${className}`}>
        {data.map((row) => (
          <div
            ...
            className="bg-mission-control-surface border border-mission-control-border rounded-lg p-4 space-y-2"
          >
            {columns.map((col) => {
  ...
  return (
    <div className={`overflow-x-auto rounded-lg border border-mission-control-border ${className}`}>
