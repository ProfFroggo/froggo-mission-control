...
export const DMFeed: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between px-4 py-2 border-b border-clawd-border">
        <h3 className="text-sm font-medium text-clawd-text">Agent Messages</h3>
        <span className="text-xs text-clawd-text-dim">{messages.length} messages</span>
      </div>
