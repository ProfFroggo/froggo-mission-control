      ...
      <div className="bg-mission-control-surface rounded-xl border border-mission-control-border p-4">
        <Flex align="start" justify="between">
          <Flex align="center" gap="3">
            {/* Google icon */}
            <div className="w-10 h-10 rounded-xl bg-mission-control-border/30 flex items-center justify-center flex-shrink-0">
          ...
          {status?.authenticated ? (
            ...
            <span className="flex items-center gap-1.5 text-xs text-mission-control-text-dim px-2.5 py-1 bg-mission-control-border/30 border border-mission-control-border rounded-full font-medium">
              <span className="w-1.5 h-1.5 rounded-full bg-mission-control-text-dim flex-shrink-0" />
              Not connected
            </span>
          )}
        </Flex>
