                    ...
                    <div key={item.id} className="px-4 py-3 hover:bg-mission-control-bg-alt/50 transition-colors">
                      ...
                      {(() => {
                        ...
                        return (
                          <div className="mb-2">
                            {preview.context && (
                              <p className="text-[10px] text-mission-control-text-dim mb-1 line-clamp-1">
                                {preview.context}
                              </p>
                            )}
                            <p className="text-xs text-mission-control-text line-clamp-2">
                              {preview.isAutoGenerated && (
                                <span className="text-[9px] font-bold px-1 py-0.5 rounded bg-info/20 text-info mr-1">AI</span>
                              )}
                              {preview.main}
                            </p>
                          </div>
