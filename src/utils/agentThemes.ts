...
export const agentThemes: Record<string, AgentTheme> = {
  ...
  'growth-director': { color: '#E65100', border: 'border-amber-600/40', bg: 'bg-amber-600/8', text: 'text-amber-400', ring: 'ring-amber-600/50', dot: 'bg-amber-400', pic: '' },
  'social-manager': { color: '#1DA1F2', border: 'border-sky-500/40', bg: 'bg-sky-500/8', text: 'text-sky-400', ring: 'ring-sky-500/50', dot: 'bg-sky-400', pic: '' },
  'lead-engineer': { color: '#795548', border: 'border-amber-700/40', bg: 'bg-amber-700/8', text: 'text-amber-300', ring: 'ring-amber-700/50', dot: 'bg-amber-300', pic: '' },
  voice: { color: '#E91E63', border: 'border-rose-500/40', bg: 'bg-rose-500/8', text: 'text-rose-400', ring: 'ring-rose-500/50', dot: 'bg-rose-400', pic: '' },
  'chat-agent': { color: '#4CAF50', border: 'border-green-500/40', bg: 'bg-green-500/8', text: 'text-green-400', ring: 'ring-green-500/50', dot: 'bg-green-400', pic: '' },
};
