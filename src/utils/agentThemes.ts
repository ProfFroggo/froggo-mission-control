...
export const agentThemes: Record<string, AgentTheme> = {
  'mission-control':     { color: '#4CAF50', border: 'border-green-500/40',  bg: 'bg-green-500/8',   text: 'text-green-400',  ring: 'ring-green-500/50',  dot: 'bg-green-400', pic: 'mission-control.png' },
  main:       { color: '#4CAF50', border: 'border-green-500/40',  bg: 'bg-green-500/8',   text: 'text-green-400',  ring: 'ring-green-500/50',  dot: 'bg-green-400', pic: 'mission-control.png' },
  ...
  inbox:      { color: '#F59E0B', border: 'border-amber-500/40',  bg: 'bg-amber-500/8',   text: 'text-amber-400',  ring: 'ring-amber-500/50',  dot: 'bg-amber-400', pic: 'inbox.png' },
  ...
  'discord-manager':  { color: '#5865F2', border: 'border-indigo-500/40', bg: 'bg-indigo-500/8', text: 'text-indigo-400', ring: 'ring-indigo-500/50', dot: 'bg-indigo-400', pic: 'discord-manager.png' },
};
